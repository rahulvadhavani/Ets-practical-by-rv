    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form class="form-horizontal" id="users_form" action="{{ route('admin.users.store') }}"
                            name="users_form" novalidate="novalidate">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div id="preview_div">
                                            <img id="image_preview" width="70" height="70"
                                                ...
                                                src="{{ asset('dist/img/default-150x150.png') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div id="file_preview"
                                                class="align-items-center d-flex justify-content-start mt-3"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <input type="hidden" id="my_city_id" value="">
