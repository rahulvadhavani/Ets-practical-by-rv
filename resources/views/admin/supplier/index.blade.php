                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <input type="hidden" id="delete_selected_url"
                            value="{{ route('admin.suppliers.delete-selected') }}">
                    </div>
                </div>
            </div>
        </div>
        <input type="hidden" id="delete_selected_url" value="{{ route('admin.suppliers.delete-selected') }}">
        <input type="hidden" id="module_name" value="{{ $module }}">
        <input type="hidden" id="module_index_url" value="{{ route('admin.suppliers.index') }}">
    </section>
    @include('admin.supplier.modal')
@endsection
@push('script')
    <script src="{{ asset('assets/js/custom/supplier.js') }}"></script>
@endpush
